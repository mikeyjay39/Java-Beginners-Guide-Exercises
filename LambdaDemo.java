...
public class LambdaDemo {
	...
	public static void main(String[] args) {
		...
		// A lambad expression myst be compatible with the method
		// defined by the funcitonal interface. Therefore, these won't work:
		// myVal = () -> "three"; // Error! String not compatible with double!
		// myPval = () -> Math.ramdon(); // Error! Paramter required!
	}
