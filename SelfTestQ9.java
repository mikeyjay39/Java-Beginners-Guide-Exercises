...
public class SelfTestQ9 {
	...
	public static void main(String[] args) {
		...
		// Define a almbda expression that reverses the contents
		...
		// This lambda expression replcaes spaces with hyphens.
		// It is embedded directly in the call to changeStr().
		outStr = changeStr((str) -> str.replace(' ', '-'), inStr);
		System.out.println("The string with spaces replcaed: " + outStr);
